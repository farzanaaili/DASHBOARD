...
const Sidebar = () => {
  ...
  const activeLink='flex items-center gap-5 pl-4 pt-3 pb-2.5 text-white text-md rounded-lg text-white m-2';
      ...
      {activeMenu && (<>
        <div className='flex justify-between items-center'>
          <Link to="/" onClick={handleCloseSidebar} className="items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white " >
            <span style={{color:currentColor, fontSize:"30px"}}>TechDSF</span>
          </Link>
